...
The goal of speech synthesis has been and still is producing natural sounding speech. TTS systems aim to create the speech from arbitrary texts given as inputs, increasing the difficulty. It is easy to assume that a considerably amount of data is needed in order to cover all the cases that could be found in an arbitrary text, but nowadays, 