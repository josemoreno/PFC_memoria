\subsection{GlottHMM configuration file}
\label{glott_conf_file}
\lstset{language=bash,breaklines=true, showstringspaces=false, frame=shadowbox, numbers=left, numberstyle=\scriptsize, rulesepcolor=\color{gray},keywordstyle=\bfseries\color{blue!40!green},commentstyle=\itshape\color{red},identifierstyle=\color{blue},stringstyle=\color{green!30!black}}
